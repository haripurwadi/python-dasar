#blobs untuk mencari countur merah (centroid, luas keliling ukuran dan komparasu)
...
mask = cv2.inRange (img, lowRed, highRed)
...
imgx = cv2.drawContours(image, contours, -1, (255,0,0), 3) #memunculkan countour
